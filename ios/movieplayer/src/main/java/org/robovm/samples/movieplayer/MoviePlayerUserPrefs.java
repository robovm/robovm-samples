...
public class MoviePlayerUserPrefs {
    ...
    private static void registerDefaults() {
        ...
        if (testValue == null) {
            ...
            NSDictionary<NSString, NSObject> appDefaults = new NSDictionary<NSString, NSObject>(new NSString(
                    SCALING_MODE_KEY),
                    scalingModeDefault, new NSString(CONTROL_STYLE_KEY), controlStyleDefault, new NSString(
    ...
    public static UIColor getBackgroundColor() {
        ...
        UIColor[] colors = new UIColor[] { UIColor.black(), UIColor.darkGray(), UIColor.lightGray(), UIColor.white(),
            UIColor.gray(), UIColor.red(), UIColor.green(), UIColor.blue(), UIColor.cyan(), UIColor.yellow(),
            UIColor.magenta(),
