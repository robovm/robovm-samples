...
public class LocateMe extends UIApplicationDelegateAdapter {
    ...
    public boolean didFinishLaunching(UIApplication application, UIApplicationLaunchOptions launchOptions) {
        if (!CLLocationManager.isLocationServicesEnabled()) {
            ...
            UIAlertView alert = new UIAlertView(NSString.getLocalizedString("DisabledTitle"),
                    NSString.getLocalizedString("DisabledMessage"), null, NSString.getLocalizedString("OKButtonTitle"));
            alert.show();
        }
