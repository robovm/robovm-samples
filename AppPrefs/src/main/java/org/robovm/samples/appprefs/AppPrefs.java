...
import org.robovm.samples.appprefs.viewcontrollers.RootViewController;
...
public class AppPrefs extends UIApplicationDelegateAdapter {
    ...
    /** Helper function that parses a Settings page file, extracts each preference defined within along with its default value. If
     * the page contains a 'Child Pane Element', this method will recurs on the referenced page file.
     * @param plistName
    ...
    private NSDictionary<?, ?> loadDefaults (String plistName, NSURL settingsBundleURL) {
        ...
        NSDictionary<NSString, NSObject> settingsDict = (NSDictionary<NSString, NSObject>)NSDictionary.read(settingsBundleURL
