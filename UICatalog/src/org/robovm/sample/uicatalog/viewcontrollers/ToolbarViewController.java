...
public class ToolbarViewController extends UIViewController{
    ...
    public void viewDidLoad() {
        ...
        //this.systemButtonPicker = new UIPickerView(new CGRect(0, 159, 320, 216));
...
//            CGRect pickerRect = new CGRect(0.0, screenRect.getHeight()-84.0f - size.height(), size.width(), size.height());
//            return pickerRect;
//    }
    ...
    private void createToolbarItems() {
        ...
        UIBarButtonItem infoItem = new UIBarButtonItem(UIImage.createFromBundle("segment_tools.png"), style, null, Selector.register("action:"));

        // create a custom button with a background image with black text for its title:
        UIBarButtonItem customItem1 = new UIBarButtonItem("Item1", UIBarButtonItemStyle.Bordered, null, Selector.register("action:"));
