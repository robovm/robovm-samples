...
public class GLES2 {
    ...
    // NOTE: most of the commented out methods below will work as is, but any methods that use
    // pointers probably need to be bridged (see the examples above for how that works)
