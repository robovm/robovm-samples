...
package org.robovm.samples.lazytableimages.ui;
...
public class RootViewController extends UITableViewController {
    ...
    private Map<Integer, IconDownloader> imageDownloadsInProgress;
    ...
    public void viewDidLoad() {
        ...
        getTableView().setDelegate(new UIScrollViewDelegateAdapter() {
            ...
            /**
             * When scrolling stops, proceed to load the app icons that are on
             * screen.
             */
            @Override
        ...
        imageDownloadsInProgress = new HashMap<>();
    }
    ...
    /**
     * If this view controller is going away, we need to cancel all outstanding
     * downloads.
     */
    @Override
    ...
    public UITableViewCell getCellForRow(UITableView tableView, NSIndexPath indexPath) {
        ...
        if (nodeCount == 0 && indexPath.getRow() == 0) {
            ...
            if (nodeCount > 0) {
                ...
                // Only load cached images; defer new downloads until scrolling
                // ends
     ...
     * don't have their app icons yet.
     */
