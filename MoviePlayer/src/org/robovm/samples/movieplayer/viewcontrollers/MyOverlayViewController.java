...
public class MyOverlayViewController extends UIViewController {
    ...
    public MyOverlayViewController(final MyMovieViewController movieViewController) {
        ...
        view.setAlpha(0.8);
        view.setBackgroundColor(UIColor.createFromWhiteAlpha(0.33, 1));
        ...
        closeButton.setTitleColor(UIColor.colorWhite(), UIControlState.Highlighted);
        ...
        playStateLabel.setTextColor(UIColor.colorDarkText());
        ...
        moviePlaybackStateText.setTextColor(UIColor.colorDarkText());
        ...
        loadStateLabel.setTextColor(UIColor.colorDarkText());
        ...
        movieLoadStateText.setTextColor(UIColor.colorDarkText());
