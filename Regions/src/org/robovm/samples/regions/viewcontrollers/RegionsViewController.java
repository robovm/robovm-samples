    ...
    public RegionsViewController () {
        ...
        updatesTableView.setDataSource(new UITableViewDataSourceAdapter() {
            ...
            public UITableViewCell getCellForRow (UITableView tableView, NSIndexPath indexPath) {
                ...
                cell.getTextLabel().setText(updateEvents.get((int)indexPath.getRow()));
        ...
        regionsMapView.setDelegate(new MKMapViewDelegateAdapter() {
            ...
            @Override
            public void didChangeDragState (MKMapView mapView, MKAnnotationView view, MKAnnotationViewDragState newState,
                ...
                if (view instanceof RegionAnnotationView) {
                    ...
                    // Once the annotation view has been dragged and placed in a new location, update and add the overlay and
// begin monitoring the new region.
    ...
    /** This method swaps the visibility of the map view and the table of region events. The "add region" button in the navigation
     * bar is also altered to only be enabled when the map is shown. */
    ...
    /*
     * This method creates a new region based on the center coordinate of the map view. A new annotation is created to represent
     * the region and then the application starts monitoring the new region.
     */
