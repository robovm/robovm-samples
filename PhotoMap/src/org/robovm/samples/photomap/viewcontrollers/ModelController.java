 ...
 * pageViewController:viewControllerBeforeViewController: and pageViewController:viewControllerAfterViewController:. It also
 * implements a custom method, viewControllerAtIndex: which is useful in the implementation of the data source methods, and in the
...
public class ModelController extends NSObject implements UIPageViewControllerDataSource {
    ...
    public DataViewController getViewControllerAtIndex (int index) {
    ...
    @Override
    public UIViewController getViewControllerBefore (UIPageViewController pageViewController, UIViewController viewController) {
    ...
    @Override
    public UIViewController getViewControllerAfter (UIPageViewController pageViewController, UIViewController viewController) {
        PhotosViewController photosViewController = (PhotosViewController)pageViewController.getDelegate();
